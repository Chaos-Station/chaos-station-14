...
public abstract class HealthAnalyzerBaseMessage : BoundUserInterfaceMessage
{
    ...
    public readonly int? BloodstreamInfectionStage;
    public readonly float? BloodstreamInfectionDuration;
        ...
        FixedPoint2 vitalDamage)  // Goobstation
    {
        ...
        BloodstreamInfectionStage = bloodstreamInfectionStage;
        BloodstreamInfectionDuration = bloodstreamInfectionDuration;
        ScanMode = scanMode;
