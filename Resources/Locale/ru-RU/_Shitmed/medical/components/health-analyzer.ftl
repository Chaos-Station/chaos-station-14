...
condition-body-bloodstream-infection = • Обнаружено заражение крови: {$stage}.
condition-body-bloodstream-infection-stage-infection = инфекция
condition-body-bloodstream-infection-stage-sepsis = сепсис
condition-body-bloodstream-infection-stage-putrid-blood = гнилокровие
